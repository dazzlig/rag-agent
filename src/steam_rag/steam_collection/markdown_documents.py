...
from steam_rag.game_metadata.playstyle import build_playstyle_metadata, coerce_list
from steam_rag.steam_collection.steam_client import classify_news_type
...
SECTION_NAMES = {
    ...
    "steam news": "news",
    "recent news": "news",
    "patch impact analysis": "analysis",
}
...
def _source_date(metadata: dict[str, str], section: str) -> str | None:
    ...
    if section == "analysis":
        return metadata.get("patch_date")
    return None
            ...
            common.update(
                {
                    ...
                    "popular_user_tag_names": coerce_list(raw.get("popular_user_tag_names")),
                    "popular_user_tag_ranks": coerce_list(raw.get("popular_user_tag_ranks")),
                    "popular_user_tags_source": raw.get("popular_user_tags_source"),
                    "popular_user_tags_language": raw.get("popular_user_tags_language"),
                    "popular_user_tags_collected_at": raw.get("popular_user_tags_collected_at"),
                    "popular_user_tags_error": raw.get("popular_user_tags_error"),
        ...
        for item_title, item_content in items:
            ...
            metadata = {
                **common,
                ...
                "url": raw.get("url"),
                "patch_date": raw.get("patch_date"),
                "patch_title": raw.get("patch_title"),
                "patch_event_type": raw.get("patch_event_type"),
                "patch_importance": raw.get("patch_importance"),
                "before_sample_size": raw.get("before_sample_size"),
                "before_positive_ratio": raw.get("before_positive_ratio"),
                "after_sample_size": raw.get("after_sample_size"),
                "after_positive_ratio": raw.get("after_positive_ratio"),
                "positive_ratio_delta_pp": raw.get("positive_ratio_delta_pp"),
                "change_direction": raw.get("change_direction"),
                "confidence_label": raw.get("confidence_label"),
                "confidence_score": raw.get("confidence_score"),
                "pagination_truncated": raw.get("pagination_truncated"),
            }
            documents.append(
